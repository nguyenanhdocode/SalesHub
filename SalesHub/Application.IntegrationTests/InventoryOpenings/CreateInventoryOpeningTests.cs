...
public class CreateInventoryOpeningTests : IClassFixture<ApplicationFixture>, IAsyncLifetime
{
    private readonly ApplicationFixture _fixture;
    private readonly IServiceScope _scope;

    public CreateInventoryOpeningTests(ApplicationFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task Create_Should_Not_Update_Balances()
    {
        ...
        try
        {
            ...
            int line1Count = await dbSession.Connection.ExecuteScalarAsync<int>(lineCountSql, new
            {
                ...
                Quantity = command.Lines[0].Quantity,
                Amount = command.Lines[0].Amount
            });
            ...
            int line2Count = await dbSession.Connection.ExecuteScalarAsync<int>(lineCountSql, new
            {
                ...
                Quantity = command.Lines[1].Quantity,
                Amount = command.Lines[1].Amount
            });
